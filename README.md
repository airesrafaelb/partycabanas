...
<body>
    ...
    <section class="hero__inner">
      <div class="hero__content">
        <a class="brand" href="#" aria-label="Party Kabanas">
          <img class="brand__logo" src="assets/logo.png" alt="Party Kabanas">
        </a>

        <p class="eyebrow">Festas do pijama infantis</p>
        <h1><span class="desktop-title">Festas do pijama mágicas, seguras e inesquecíveis</span><span class="mobile-title">Festas do pijama<br>mágicas, seguras<br>e inesquecíveis</span></h1>
        <p class="hero__subtitle">Transformamos momentos especiais em experiências encantadoras, com cabaninhas personalizadas, decoração delicada e todo o cuidado que as crianças merecem.</p>
    ...
    <div class="about__inner">
      <div class="about__content">
        <h2 class="about__title">
          ...
          <span class="about__script">criando memórias...</span>
        </h2>
        ...
        <div class="about__story">
          <h3>Quem somos?</h3>
          <p>Desde 2015, nasceu no coração da minha primogênita o desejo de ter uma festa do pijama. Com isso, esse sonho se tornou realidade e, logo após, nasceu a Party Kabanas.</p>
          <p>Com mais de 2.000 sonhos e festas realizadas, fomos pioneiras em festa do pijama no Ceará, criando noites especiais para crianças viverem momentos inesquecíveis com seus melhores amigos.</p>
          <p>Trabalhamos com cenários encantadores, cabanas e tendas diferenciadas, em diversas cores e temas personalizados, além de lembrancinhas exclusivas desenvolvidas de acordo com cada ocasião.</p>
        </div>
        ...
        <div class="about__card">
          ...
          <p>Cada detalhe é pensado para encantar as crianças e tranquilizar os pais.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="process" id="como-funciona" aria-label="Como funciona a Party Kabanas">
    <div class="process__inner">
      <div class="section-heading">
        <h2>Como funciona</h2>
        <p>A gente cuida de tudo para que seja inesquecível!</p>
      ...
      <div class="steps">
        <article class="step">
          ...
          <p>Você nos conta sua ideia e recebe um orçamento personalizado.</p>
        </article>
        ...
        <article class="step">
          ...
          <h3>Você escolhe o tema da festa</h3>
          <p>Escolha o tema, a data e os detalhes que vão tornar tudo único e especial.</p>
        </article>
        ...
        <article class="step">
          ...
          <h3>Confirmação</h3>
          <p>A confirmação é feita após o envio do comprovante de 50% do valor combinado.</p>
        </article>
        ...
        <article class="step">
          ...
          <h3>As crianças aproveitam a experiência</h3>
          <p>Diversão, conforto e momentos mágicos que ficam para sempre na memória.</p>
        </article>
        ...
        <article class="step">
          ...
          <p>Cuidamos de tudo até o último detalhe para você não se preocupar com nada.</p>
        </article>
      </div>

      <div class="process__assurance" aria-label="Garantias da experiência">
        <div class="assurance">
          <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path d="M12 3 20 7v5c0 5-3.4 8.5-8 9-4.6-.5-8-4-8-9V7l8-4Z"></path>
            <path d="m9 12 2 2 4-5"></path>
        ...
        <div class="assurance">
          ...
          <span>Decoração encantadora</span>
        </div>
        <div class="assurance">
          <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path d="M20.8 4.6a5.4 5.4 0 0 0-7.6 0L12 5.8l-1.2-1.2a5.4 5.4 0 1 0-7.6 7.6L12 21l8.8-8.8a5.4 5.4 0 0 0 0-7.6Z"></path>
          </svg>
          <span>Experiência completa e sem preocupações</span>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="events__inner">
      <div class="events__grid">
        <div class="events__intro">
          ...
          <h2>Festas reais que já encantaram famílias</h2>
          <p>Veja algumas experiências já criadas pela Party Kabanas, com temas personalizados, decoração delicada e todo o cuidado que cada momento merece.</p>
        ...
        <figure class="event-card event-card--wide">
          <img src="assets/gallery-01.png" alt="Festa do pijama com cabanas e esteiras pink em salão amplo">
        </figure>
        <figure class="event-card event-card--top">
          <img src="assets/gallery-02.png" alt="Cabaninhas brancas com brinquedos e iluminação lilás">
        </figure>
        <figure class="event-card event-card--left">
          <img src="assets/gallery-03.png" alt="Cabaninha iluminada com decoração colorida e bandejas personalizadas">
        </figure>
        <figure class="event-card event-card--middle-a">
          <img src="assets/gallery-04.png" alt="Cabanas lilás em corredor com decoração de balões ao fundo">
        </figure>
        <figure class="event-card event-card--middle-b">
          <img src="assets/gallery-05.png" alt="Cabanas brancas com balões rosados e luzes aconchegantes">
        </figure>
        <figure class="event-card event-card--right">
          <img src="assets/gallery-06.png" alt="Cabanas temáticas pretas com decoração Jurassic Park">
        </figure>
        <figure class="event-card event-card--bottom-a">
          <img src="assets/gallery-07.png" alt="Festa do pijama colorida com tendas, almofadas e lembrancinhas">
        </figure>
        <figure class="event-card event-card--bottom-b">
          <img src="assets/gallery-08.png" alt="Festa temática colorida com almofadas e balões em salão iluminado">
        </figure>
      </div>
      ...
      <a class="events__instagram" href="https://www.instagram.com/partykabanas" target="_blank" rel="noopener">
        ...
        Veja mais inspirações no Instagram
      </a>
    </div>
  </section>

  <section class="contact" id="orcamento" aria-label="Contato e orçamento Party Kabanas">
    <div class="contact__inner">
      <div class="contact__copy">
        <h2 class="contact__title">Fale conosco e peça seu orçamento</h2>
        <p class="contact__subtitle">É rápido, fácil e personalizado!</p>
        ...
        <div class="contact__steps">
          ...
          <div class="contact-step">
            ...
            <div>
              ...
              <p>Montamos uma proposta personalizada para o que você sonhou.</p>
            </div>
          </div>
          ...
          <div class="contact-step">
            ...
            <div>
              ...
              <p>Sua reserva é confirmada após o envio do comprovante de pagamento de 50% do valor combinado.</p>
            </div>
          </div>
          ...
          <div class="contact-step">
            ...
            <div>
              ...
              <p>Estamos aqui para cuidar de cada detalhe e tirar todas as suas dúvidas.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="whatsapp-card">
          ...
          <p>e comece a planejar uma experiência inesquecível!</p>
        ...
        <div class="contact__trust">
          ...
          <div class="trust-item">
            ...
            <span>Atendimento rápido e atencioso</span>
          </div>
          <div class="trust-item">
            <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path d="M12 3 20 7v5c0 5-3.4 8.5-8 9-4.6-.5-8-4-8-9V7l8-4Z"></path>
  ...
  <footer class="site-footer" id="rodape" aria-label="Rodapé Party Kabanas">
    <div class="footer__inner">
      <img class="footer__logo" src="assets/logo.png" alt="Party Kabanas">
      ...
      <div class="footer__links">
        ...
        <div class="footer__item footer__copyright">
          ...
          <span>© Party Kabanas. Todos os direitos reservados.</span>
        </div>
      </div>
    </div>
  </footer>
